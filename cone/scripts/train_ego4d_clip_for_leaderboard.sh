...
text_feat_dir=/s1_md0/leiji/v-zhijian/ego4d_nlq_data_for_cone/offline_lmdb/egovlp_clip_text_features
...
adapter_module=$4
exp_id=exp_leaderboard_${max_v_l}_${num_queries}_${adapter_module}_${clip_length}
