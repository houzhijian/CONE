""" Dataset loader for the Ego4d-NLQ dataset """
import os
...
class Ego4d(data.Dataset):
    def __init__(self, split, is_eval=True):
        super(Ego4d, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        if self.eval:
            ...
            pos_overlaps = iou(torch.stack([s_times[:, None].expand(-1, num_clips),
                               ...
                               torch.tensor([start_pos, end_pos]).tolist()).reshape(num_clips, num_clips)
