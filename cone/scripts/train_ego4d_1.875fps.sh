...
motion_feat_dir=/s1_md0/leiji/v-zhijian/ego4d_nlq_data_for_cone/offline_lmdb/egovlp_video_feature_1.875fps
...
max_v_l=$3
bsz=32
clip_length=0.53333 ## we extract video feature every 1.875 FPS, thus a clip duration is 1/1.875 = 0.53333 second
max_q_l=20
num_workers=4
